...
/* Saying that the props that are being passed into the OrderSummary component are optional. */
interface Props {
    orderValues?: {
...
export const OrderSummary: FC<Props> = ({ orderValues }) => {
    ...
    /* A ternary operator. It is saying if orderValues is true, then use orderValues, otherwise use the
